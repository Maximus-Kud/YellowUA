        ...
        <div className='header-content'>
          <div id='left-part'>
            <div id='hotline-number'>
              (093) 811 28 44
              <svg height="800px" width="800px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" enableBackground="new 0 0 50 50" transform="matrix(6.123233995736766e-17,1,1,-6.123233995736766e-17,0,0)">
          ...
          <div id='icons-block'>
            <button id='login-button'>
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.99998 10.0003C12.3012 10.0003 14.1666 8.13485 14.1666 5.83366C14.1666 3.53247 12.3012 1.66699 9.99998 1.66699C7.69879 1.66699 5.83331 3.53247 5.83331 5.83366C5.83331 8.13485 7.69879 10.0003 9.99998 10.0003Z" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M14.1667 11.667H14.46C15.0692 11.6672 15.6574 11.8898 16.1141 12.2931C16.5708 12.6963 16.8645 13.2525 16.94
                    ...
                    12.2925C4.34272 11.8892 4.93132 11.6668 5.54084 11.667H5.83334" stroke="black" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </svg>
              <span style={{fontFamily: 'Montserrat-SemiBold'}}>Увійти</span>
            </button>

            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g opacity="0.64" clipPath="url(#clip0_1928_120)">
                <path d="M7 20H17" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M6 6L12 5L18 6" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M12 3V20" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M9 12L6 6L3 12C3 12.7956 3.31607 13.5587 3.87868 14.1213C4.44129 14.6839 5.20435 15 6 15C6.79565 15 7.55871 14.6839 8.12132 14.1213C8.68393 13.5587 9 12.7956 9 12Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M21 12L18 6L15 12C15 12.7956 15.3161 13.5587 15.8787 14.1213C16.4413 14.6839 17.2044 15 18 15C18.7956 15 19.5587 14.6839 20.1213 14.1213C20.6839 13.5587 21 12.7956 21 12Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </g>
              <defs>
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <g opacity="0.64">
                <path d="M3.97689 9.84C4.01712 9.33881 4.24464 8.87115 4.61417 8.53017C4.98369 8.18918 5.46808 7.9999 5.97089 8H18.0289C18.5317
                  ...
                  21.1533 3.36719 20.9139 3.27706 20.6529C3.18693 20.392 3.1518 20.1152 3.17389 19.84L3.97689 9.84V9.84Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                <path d="M16 11V6C16 4.93913 15.5786 3.92172 14.8284 3.17157C14.0783 2.42143 13.0609 2 12 2C10.9391 2 9.92172 2.42143 9.17157 3.17157C8.42143
                  3.92172 8 4.93913 8 6V11" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              </g>
            </svg>
          </div>
        </div>
